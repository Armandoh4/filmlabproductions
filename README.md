...
| :-------- | :-----|
|"Element ul not allowed as child of element ul in this context"|I changed the "ul" tag to a "li" tag and the error was resolved in all navigations across all my pages|
